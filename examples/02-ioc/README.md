...
### 01-without-ioc-basic.ts
Базовый пример работы без IoC. Показывает:
- Как создавать зависимости вручную
- Передачу объектов в конструкторы
- Проблемы подхода без IoC

### 02-without-ioc-nested.ts
Пример работы без IoC с вложенными зависимостями. Показывает:
- Сложность ручного создания цепочки зависимостей
- Необходимость знать все зависимости заранее

### 03-simple-ioc-container.ts
